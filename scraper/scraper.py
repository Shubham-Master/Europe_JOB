...
def run_all_scrapers(profile_path: str = "data/profile.json", output_path: str = "data/jobs_raw.json"):
    """
...
if __name__ == "__main__":
    profile = sys.argv[1] if len(sys.argv) > 1 else "data/profile.json"
    output = sys.argv[2] if len(sys.argv) > 2 else "data/jobs_raw.json"
